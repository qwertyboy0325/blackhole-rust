...
RGB, when present, is scene-linear ACEScg with chromaticities in metadata;
display-referred PNG is optional and non-authoritative. A canonical JSON sidecar
